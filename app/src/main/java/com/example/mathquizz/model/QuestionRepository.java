...
public class QuestionRepository {
    ...
    public List<Question> getListQuestions(){
       return new ArrayList<Question>(){{
           add(new Question("In a clothing store, 1500 clothes are sold daily for 7 days. How many days will 200 clothes be sold?"
                   , 1, 4));

           add(new Question("In a steakhouse, 5 pigs are roasted, out of a total of 10. If it is necessary to roast 3 pigs for 50 people, how many pigs will need to be roasted for 250 people?"
                   , 15, 20));
